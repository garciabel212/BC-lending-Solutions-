          ...
          <div className="md:col-span-2">
            ...
            <ul className={`space-y-4 text-sm ${theme === 'dark' ? 'text-white/50' : 'text-slate-500'}`}>
              ...
              <li className="flex flex-col gap-1">
                <span className={`font-bold text-[9px] uppercase tracking-wider ${theme === 'dark' ? 'text-gold' : 'text-gold'}`}>Ind. NMLS 2616069</span>
                <span className={`font-bold text-[9px] uppercase tracking-wider ${theme === 'dark' ? 'text-gold' : 'text-gold'}`}>Co. NMLS 2805990</span>
              </li>
            </ul>
          </div>
        </div>
