...
export async function getAdvisorResponse(userMessage: string, history: { role: 'user' | 'assistant', content: string }[], lang: Language) {
  ...
  try {
    ...
    return lang === 'en' 
      ? "I encountered an error. Please reach out to our office at ufinancings@bcprimelendingsolutions.com or call (786) 710-1976."
      : "Se ha producido un error. Por favor, comuníquese con nuestra oficina en ufinancings@bcprimelendingsolutions.com o llame al (786) 710-1976.";
  }
}
